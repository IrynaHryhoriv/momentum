...
//     img.src = `https://raw.githubusercontent.com/dinapravoslavnova/stage1-tasks/assets/images/${timeOfDay}/${bgNum}.jpg`;
...
//   if (imgTag.value.length === 0) {
//     url = `https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=0c7dcea5fb71cb279ab05390c446850a&tags=${timeOfDay}&extras=url_l&format=json&nojsoncallback=1`;
//   } else {
//     url = `https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=0c7dcea5fb71cb279ab05390c446850a&tags=${imgTag.value}&extras=url_l&format=json&nojsoncallback=1`;
//   }
//   const res = await fetch(url);
//   const data = await res.json();
...
//   url = `https://api.openweathermap.org/data/2.5/weather?q=${city.value}&lang=${lang}&appid=25ff0737f3d55ac8fc15bd8e559bac48&units=metric`;
//   const res = await fetch(url);
//   const data = await res.json();
//   if (data.cod === 200) {
